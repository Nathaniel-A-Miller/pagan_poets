...
export default function ReferenceExplorer({ pooledData, searchQuery = '' }) {
  ...
  // 2. Filter matches strictly using the global searchQuery prop
  ...
  return (
    <div className="explorer">
      ...
      <div className="ref-list">
        ...
        {filtered.length === 0 && (
          <div className="no-results" style={{ direction: 'ltr', unicodeBidi: 'bidi-override', textAlign: 'center', padding: '3rem' }}>
